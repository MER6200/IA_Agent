    ...
    class react(CyclicBehaviour):
        async def run(self):
            ...
            if message:
                ...
                elif message.get_metadata("ontology") == onto2 and message.get_metadata("performative") == perform:
                    print('Admin_1 !! : Message recu de : {}'.format(message.sender))
                    ## Question 6 : recevoir le premier message "module2"................
                ...
                # Reception du message d'Admin pour savoir si je peux envoyer les notes
                elif message.get_metadata("ontology") == "Note" and message.get_metadata("performative") == perform:
                    print('Admin_1 !! : Message recu de : {}'.format(message.sender))
                    print("Il a envoyé :{}".format(message.body))
                    # On a bien les 2 note de l'étudiant
                    if Admin_1.compt2 == 2 and Admin_1.compt1 == 2:
                        message5 = Message(to='Admin_2@jabber.ig.umons.ac.be')
                        message5.set_metadata("performative", 'inform')
                        message5.set_metadata("ontology", "Note")
                        message5.body ="Accord"  # contenu du message
                        await self.send(message5)
                        time.sleep(2)
